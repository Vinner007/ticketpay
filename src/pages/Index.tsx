      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          ...
          <div className="text-lg md:text-xl mb-12 text-muted-foreground">
            ...
            <span className="mx-2">72 รอบ</span> • 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-card border-2 border-primary/20 rounded-lg p-8">
              <h3 className="text-2xl font-semibold mb-6 text-center text-primary">ข้อมูลงาน 3 วัน</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                  <div className="text-4xl font-bold text-primary mb-2">2</div>
                  <div className="text-sm text-muted-foreground">เรื่องราว</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-primary mb-2">72</div>
                  <div className="text-sm text-muted-foreground">รอบทั้งหมด</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-primary mb-2">504</div>
                  <div className="text-sm text-muted-foreground">ที่นั่งทั้งหมด</div>
                </div>
                <div>
                  <div className="text-4xl font-bold text-primary mb-2">10</div>
                  <div className="text-sm text-muted-foreground">นาที/รอบ</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card border-2 border-secondary/20 rounded-lg p-8">
              <h3 className="text-2xl font-semibold mb-6 text-center text-secondary">ตารางเวลา</h3>
              <div className="space-y-4 text-sm">
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-border pt-2">
                  <div>29 ต.ค.</div>
                  <div>10:00-17:00</div>
                  <div className="text-muted-foreground">พัก 12:00-12:30, 14:30-15:00</div>
                </div>
                <div className="grid grid-cols-3 gap-4 border-t border-border pt-2">
                  <div>30 ต.ค.</div>
                  <div>10:00-17:00</div>
                  <div className="text-warning">มีพิธีเปิดงาน 13:00-13:30</div>
                </div>
                <div className="grid grid-cols-3 gap-4 border-t border-border pt-2">
                  <div>31 ต.ค.</div>
                  <div>10:00-17:00</div>
