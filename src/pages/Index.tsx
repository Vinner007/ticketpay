...
const Index = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "เด็กที่มีอายุ 5 ปีขึ้นไปต้องซื้อตั๋วเหมือนผู้ใหญ่ (อายุขั้นต่ำในการเข้าร่วม 5 ปี)",
    },
  ];
      ...
      <footer className="relative py-12 bg-card border-t-2 border-border">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center text-muted-foreground border-t border-border pt-8">
            <p>&copy; 2025 The Homicide Blood Halloween Event. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
