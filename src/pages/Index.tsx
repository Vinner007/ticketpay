...
// 🔥 Max Capacity แต่ละวัน (2 เนื้อเรื่อง × 252 คน = 504 คนต่อวัน)
const MAX_CAPACITY_PER_DAY: Record<string, number> = {
  "2025-10-29": 504,
  "2025-10-30": 504, // มีพิธีเปิดงานแต่ที่นั่งเต็ม 504
  "2025-10-31": 504,
};
...
const Index = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "เปิดทุกวัน 10:00-17:00 น. แบ่งเป็น 3 รอบหลัก: รอบเช้า (10:00-12:00 รับ 84 คน), รอบบ่าย (12:30-14:30 รับ 84 คน), และรอบเย็น (15:00-17:00 รับ 84 คน) มีเวลาพักเบรก 12:00-12:30 และ 14:30-15:00 น. วันที่ 30 ตุลาคมมีพิธีเปิดงานพิเศษโดยท่านรองวิรัส เวลา 13:00-13:30",
    },
    {
      question: "จำนวนที่นั่งแต่ละวันเท่าไหร่?",
      answer: "แต่ละเรื่องรับได้ 252 คนต่อวัน (แบ่งเป็น 3 รอบ รอบละ 84 คน) รวม 3 วันเรื่องละ 756 คน × 2 เรื่อง = 1,512 คนทั้งหมด",
    },
    {
  ...
  // 🔥 คำนวณยอดรวม (2 เรื่อง × 756 คนต่อเรื่อง)
  const totalCapacity = 1512; // 2 stories × 756 people per story
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          ...
          <div className="text-lg md:text-xl mb-12 text-muted-foreground">
            ...
            <span className="mx-2">216 รอบ</span> • 
