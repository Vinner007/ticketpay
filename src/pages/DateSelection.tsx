      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 max-w-7xl">
        ...
        <Card className="mt-12 p-6 bg-card/50 max-w-4xl mx-auto">
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <p className="text-primary font-semibold mb-3">🎭 ในแต่ละวันมี 2 เนื้อเรื่องดำเนินการพร้อมกัน</p>
            <p>• <span className="text-foreground font-semibold">🌅 รอบเช้า:</span> 10:00 - 12:00 น. (รองรับ 84 คนต่อเรื่อง = 168 คนต่อรอบ)</p>
            <p>• <span className="text-foreground font-semibold">พักเบรก:</span> 12:00 - 12:30 น.</p>
            <p>• <span className="text-foreground font-semibold">☀️ รอบบ่าย:</span> 12:30 - 14:30 น. (รองรับ 84 คนต่อเรื่อง = 168 คนต่อรอบ)</p>
            <p>• <span className="text-foreground font-semibold">พักเบรก:</span> 14:30 - 15:00 น.</p>
            <p>• <span className="text-foreground font-semibold">🌆 รอบเย็น:</span> 15:00 - 17:00 น. (รองรับ 84 คนต่อเรื่อง = 168 คนต่อรอบ)</p>
            <p className="text-primary font-semibold mt-4">📊 รวมต่อวัน: 504 คน (3 รอบ × 2 เนื้อเรื่อง × 84 คน)</p>
            <p className="text-muted-foreground mt-2">• รวมต่อเนื้อเรื่อง: 252 คน (3 รอบ × 84 คน)</p>
